...
export default function ArtworkPage() {
  ...
  const goToArtwork = async (index: number) => {
    ...
    if (nextArt) {
      ...
      router.push(`/chap-5/artwork/${encodeURIComponent(nextArt.artTitle)}`);
      ...
      >
        ...
        <div
          style={{
            ...
            width: "100%",
            height: "100%",
            backgroundImage: "url('/chap-bg-3.png')",
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <img
              src={"/artworks/chap-5-photos/" + artwork["art-image"]}
                ...
                <Button
                  onClick={async () => {
                    ...
                    const lastChapter1Art =
                      chapter4Arts[chapter4Arts.length - 1];
                    if (lastChapter1Art) {
                      router.push(
                        `/chap-5
                        `
      ...
      <ViewImage
        ...
        imageSrc={"/artworks/chap-5-photos/" + artwork["art-image"]}
