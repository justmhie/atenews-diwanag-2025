    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <img
              src={"/artworks/chap-2-photos/" + artwork["art-image"]}
                ...
                <Button
                  onClick={async () => {
                    ...
                    const chapter2Arts = data.filter(
                      (art) => art.chapter === "Chapter 2 Overview"
                    );
                    const lastChapter1Art =
                      chapter2Arts[chapter2Arts.length - 1];
                    if (lastChapter1Art) {
                      router.push(
                        `/chap-1/artwork/${encodeURIComponent(
                          lastChapter1Art.artTitle
                        )}`
                      );
                    } else {
                      router.push("/chap-2");
      ...
      <ViewImage
        ...
        imageSrc={"/artworks/chap-2-photos/" + artwork["art-image"]}
