    ...
    >
      ...
      >
        ...
        <header style={{ textAlign: "center", marginBottom: "3rem" }}>
          ...
          <p style={{ color: "#D4AF37", opacity: 0.8, fontFamily: "averia-serif", fontSize: "18px" }}>
        ...
        <div style={{ 
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.3rem" }}>
                <p style={{ color: "#F8FFD8", fontSize: "17px", lineHeight: "1.8", fontFamily: "averia-serif", margin: 0 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.3rem" }}>
                <p style={{ color: "#F8FFD8", fontSize: "17px", lineHeight: "1.8", fontFamily: "averia-serif", margin: 0, fontStyle: "italic" }}>
                  Editor-in-Chief
                </p>
                <p style={{ color: "#F8FFD8", fontSize: "17px", lineHeight: "1.8", fontFamily: "averia-serif", margin: 0, fontStyle: "italic" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.3rem" }}>
                ...
                <p style={{ color: "#05101C", fontSize: "17px", lineHeight: "1.8", fontFamily: "averia-serif", margin: 0 }}>
                  .
                </p>
                <p style={{ color: "#05101C", fontSize: "17px", lineHeight: "1.8", fontFamily: "averia-serif", margin: 0 }}>
                  .
